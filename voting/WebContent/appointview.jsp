...
<table class="table  table-hover table-dark">
 <thead>
    <tr class="table-dark">
      ...
      <th style="text-align: center;">Candidate Name</th>
       ...
       con=dbconn.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `vote`.`eligible` where statuss='Eligible'");
     ...
     <tr class="table-dark">
     <td style="text-align: center;"><img src="candidate/<%=pic%>" style="width:60px; height:60px;"></td>
 ...
 <td style="text-align: center;"><%= rs.getString(5) %></td>
       <td style="text-align: center;"><%=  rs.getString(1) %></td>
          ...
          <td style="text-align: center;"><img src="symbol/<%=pics%>" style="width:60px; height:60px;"></td>
