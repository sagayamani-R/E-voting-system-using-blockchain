...
INSERT INTO `candidateid` (`district`,`assem`,`email`,`mobile`,`pic`,`status`) VALUES 
 ('Chennai','Perambur','dhoni@gmail.com','07338723231','images (49).jfif','Apply'),
 ('Chennai','Anna nagar','thanush@gmail.com','07338723231','Screenshot_20240907_175322.png','Apply');
...
INSERT INTO `candidatereg` (`name`,`email`,`mobile`,`Assembly`,`district`) VALUES 
 ...
 ('spiro','dhoni@gmail.com','07338723231','Perambur','Chennai'),
 ('Thirumoorthy','jgj@gmail.com','07338723231','TNagar','Chennai'),
 ('vengadesh','logn@gmail.com','8264464545','perambur','chennai'),
 ('Thalapathi','thala@gmail.com','9010203040','Rk nagar','chennai'),
 ('thanush','thanush@gmail.com','07338723231','Anna nagar','Chennai'),
...
CREATE TABLE `face` (
  ...
  `name` varchar(45) DEFAULT NULL,
  `uniqueid` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `voteid` (`district`,`assem`,`email`,`mobile`,`pic`,`status`,`edate`,`votekey`) VALUES 
 ...
 ('Chennai','Anna nagar','mailjavasend@gmail.com','07338723231','images (50).jfif','Allot','2024-09-07',''),
 ...
 ('Chennai','TNagar','thanush@gmail.com','07338723231','Untitled Diagram.drawio (3).png','Allot','2024-09-09','');
...
INSERT INTO `voterreg` (`name`,`email`,`mobile`,`district`,`assem`,`otp`) VALUES 
 ('spiro','mailjavasend@gmail.com','07338723231','Chennai','Anna nagar','G82HF'),
 ('thanush','thanush@gmail.com','07338723231','Chennai','Anna nagar','B6EH7');
