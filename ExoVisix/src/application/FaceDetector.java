						...
						if (faces != null) {
							...
							for (int i = 0; i < total; i++) {
								...
								if (isRecFace) {
									...
									System.out.println("Value of er jhgbefore condition: " + er);
									if(recogniseCode != -1)
									{
										...
										Connection con;
			                              ...
			                              con=dbconn.create();
													PreparedStatement ps=con.prepareStatement("UPDATE vote.face f SET status='permit' where voterid='"+this.recogniseCode+"' ");
